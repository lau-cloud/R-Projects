...
world_cont <- cartogram_cont(population_2020, "population", itermax = 5)


population_2020 <- tm_shape(world_cont) + tm_fill("population", 
                                                  style = "jenks", 
                                                  palette= "cividis",
                                                  title="Population") +
...
tmap_save(population_2020, "cividis_2020.png", width = 10, height=7)
