...
world_cont <- cartogram_cont(population_2050, "population", itermax = 5)


population_2050 <- tm_shape(world_cont) + tm_fill("population", 
                                                  style = "jenks", 
                                                  palette= "cividis",
                                                  title="Population") +
...
tmap_save(population_2050, "cividis_2050.png", width = 10, height=7)
