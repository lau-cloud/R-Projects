...
world_cont <- cartogram_cont(population_2100, "population", itermax = 5)


population_2100 <- tm_shape(world_cont) + tm_fill("population", 
                                                  style = "jenks", 
                                                  palette= "cividis",
                                                  title="Population") +
...
tmap_save(population_2100, "cividis_2100.png", width = 10, height=7)
